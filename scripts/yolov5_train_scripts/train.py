...
def train_model(data_yaml_path, epochs=100, batch_size=16, img_size=640):
    ...
    cmd = [
        ...
        '--project', '../runs/train',
        '--name', 'solar_defect_detection_combined_dataset_200_16'
    ]
...
def main():
    # Setup paths
    data_yaml_path = Path(r'C:\Users\Eduar\Documents\masters\cap5415\combined_solar_dataset\dataset_info.yaml')
